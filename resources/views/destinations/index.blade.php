         ...
         <table class="w-full whitespace-no-wrap">
             ...
             <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                 ...
                 <tr class="text-gray-700 dark:text-gray-400">
                     ...
                     <td class="justify-center px-4 py-3 text-sm "><a href="{{route('destination.show', $destination->slug)}}" class="">{{$destination->name}} </a></td>
                     <td class="text-sm font-medium text-center text-green-500 ">${{$destination->price}} </td>
                     <td class="px-4 py-3 text-sm font-medium text-center">{{$destination->location}} </td>
                     <td>
                         <div class="flex flex-row items-baseline justify-center gap-2 pt-2 text-gray-400">
                             ...
                             <form action="{{route('destination.destroy', $destination->slug)}}" method="POST" class="hover:text-teal-500 d-inline-block">
                                 @csrf
                                 @method('DELETE')
                                 <button class="w-6 h-6" onclick="return confirm('Are you sure?');">
