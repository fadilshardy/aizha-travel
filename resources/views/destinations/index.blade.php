 ...
 <div class="w-full pt-8 overflow-hidden rounded-lg shadow-xs">
     <div class="flex items-end justify-end w-full py-2">
         <a href="{{route('destination.create')}}" class="flex items-center gap-1 py-1 font-medium bg-teal-700 btn Capitalize">
             add
         </a>
     </div>
     <div class="w-full overflow-auto">
         ...
         <table class="w-full p-2 m-1 whitespace-no-wrap">
             ...
             <tbody class="w-full bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                 ...
                 <tr class="overflow-y-scroll text-gray-700 dark:text-gray-400 ">
                     ...
                     <td class="justify-center px-4 py-3 text-xs sm:text-sm"><a href="{{route('destination.show', $destination->slug)}}" class="">{{$destination->name}} </a></td>
                     <td class="text-xs font-medium text-center text-green-500 sm:text-sm ">${{$destination->price}} </td>
                     <td class="py-3 text-xs font-medium text-center sm:text-sm">{{$destination->location}} </td>
                     <td>
