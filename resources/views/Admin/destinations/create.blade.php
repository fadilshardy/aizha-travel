                 ...
                 <div class="col-span-2 lg:col-span-1">
                     <div class="flex flex-col w-full gap-2 lg:flex-row ">
                         ...
                         <div class="w-full">
                             ...
                             <input type="number" name="total_days" id="duration" class="block w-full px-2 py-2 form-input @error('total_days') border-red-500 @enderror" placeholder="duration of the package" value="{{ old('total_days')}}" />
