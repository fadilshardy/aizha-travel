...
<div class="container py-6 mx-auto">
    ...
    <div class="flex flex-col max-w-full overflow-hidden bg-white rounded shadow-lg">
        ...
        <div class="mx-4 mt-8 mb-4">
            <button class="w-full p-2 mr-5 text-xl font-bold text-center text-white transition bg-teal-500 rounded duration-7000 hover:bg-teal-400 group-hover:visible " type="submit">Book now</button>
        </div>
    </div>
</div>
</form>
