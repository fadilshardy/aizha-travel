                     ...
                     <td class="hidden py-3 lg:block ">
                         <div class="flex items-center justify-center">
                             <div class="w-32 h-full">
                                 <img class="object-cover w-full h-full rounded-lg" src="{{$order->user->getAvatarUrl()}}" alt="" loading="lazy" />
                             </div>
                         </div>

                     </td>
                     <td class="justify-center px-4 py-3 text-xs sm:text-sm"><a href="{{route('order.show', $order->id)}}" class="">{{$order->user->name}} </a></td>
                     <td class="text-xs font-medium text-center text-green-500 sm:text-sm ">{{$order->destination->location}} </td>
                     <td class="py-3 text-xs font-medium text-center sm:text-sm">{{$order->location}} </td>
                     <td>
