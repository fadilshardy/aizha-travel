 ...
 @include('user.orders.partials.reciept_form_modal')
                 ...
                 <div class="border-b border-gray-200 p-9">
                     <div class="space-y-6">
                         <div class="flex justify-between items-top">
                             <div class="space-y-4">
                                 <div>
                                     <p class="text-lg font-bold">Order</p>
                     ...
                     <div class="flex justify-center w-full">
                         <button class="flex items-center justify-center p-4 mt-6 text-center bg-black btn-dashboard hover:bg-teal-900" onclick="openModal('modal')">Pay now</button>
                     </div>
                     @endif
